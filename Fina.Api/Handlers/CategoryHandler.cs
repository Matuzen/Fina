...
public class CategoryHandler(AppDbContext context) : ICategoryHandler
{
    ...
    public async Task<PagedResponse<List<Category>?>> GetAllAsync(GetAllCategoriesRequest request)
    {
       ...
       try
        {
            // 1° fazemos uma query. 2° fazemos a paginação. 3° A contagem de páginas
        ...
        {
            return new PagedResponse<List<Category>?> (null, 500, "Não foi possível recuperar a lista de categorias");
        }
